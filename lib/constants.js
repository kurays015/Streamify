export const urls = [
  ...
  `${process.env.SOURCE_URL}/meta/anilist/popular?perPage=20`,
  `${process.env.SOURCE_URL}/meta/anilist/recent-episodes`,
  `${process.env.SOURCE_URL}/meta/anilist/trending?perPage=20
  `,
];
